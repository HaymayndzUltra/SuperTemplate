...
**Elements to Specify**:
1. **Structure**: Sections, headers, organization (hierarchical depth, nesting levels, section order)
2. **Formatting**: Markdown, code blocks, tables, etc. (exact syntax, language tags, style conventions)
3. **Required Elements**: What must be included in the output (mandatory sections, essential components)
4. **Optional Elements**: What can be included if relevant (nice-to-have sections, additional examples)
5. **Length Guidelines**: Approximate length or detail level (word count, line count, section count, with ranges)
6. **Directive Markers**: [STRICT], [GUIDELINE], [BLOCKING] usage if applicable
...
### Structure
- Use [H1/H2/H3] headers for [main sections/subsections] with [specific hierarchy rules]
- Organize content as [linear/hierarchical/modular] with [specific organization method]
- Include [required sections list] in [specific order] with [specific content requirements]
- Nesting depth: [maximum levels] with [specific nesting rules]

### Formatting
- Code blocks: Use ```[language] with syntax highlighting and [specific style conventions]
- Lists: Use [numbered/bulleted] format for [purpose] with [specific nesting rules]
- Tables: Use markdown tables for [data type] with [specific column requirements]
- Emphasis: Use **bold** for [key terms] and *italic* for [emphasis] with [specific usage rules]
- Directives: Use [STRICT] for [purpose], [GUIDELINE] for [purpose], [BLOCKING] for [purpose]

### Required Elements
1. [Element 1]: [Description and purpose] with [specific requirements]
2. [Element 2]: [Description and purpose] with [specific requirements]
3. [Element 3]: [Description and purpose] with [specific requirements]

### Optional Elements
- [Element]: Include if [condition] with [specific criteria]
- [Element]: Add when [relevant scenario] with [specific triggers]

### Length Guidelines
- Minimum: [X words/lines/sections] for [scope level]
- Target: [Y words/lines/sections] for [scope level]
- Maximum: [Z words/lines/sections] for [scope level] (if applicable)
- Detail level: [Surface/Moderate/Deep/Exhaustive] with [specific criteria]
```
...
### Required Knowledge
- [Background knowledge areas - from Phase 1]
- [Technical concepts required - from Phase 1]
- [Domain expertise needed - from Phase 1]

### Available Resources
- [Input data/sources - from Phase 1 or inferred]
- [Tools/APIs available - inferred or specified]
- [Reference materials - inferred or "none provided"]

### Constraints & Assumptions
- [Limitations - from Phase 1]
- [Assumptions - from Phase 1]
- [Scope boundaries - from Phase 1]

---

## YOUR ROLE
You are a [role definition - from Phase 1] who [primary function - from Phase 1]. Your core competencies include:
- [Competency 1 - from Phase 1]
- [Competency 2 - from Phase 1]
- [Competency 3 - from Phase 1]
...
### Input Types
- [Type 1]: [Description - from Phase 1 or inferred]
- [Type 2]: [Description - from Phase 1 or inferred]

### Input Format
- [Format requirements - from Phase 1]
- [Validation criteria - enhanced with specificity]

### Input Validation
**[STRICT]** Before proceeding, verify:
- ✓ [Checkpoint 1 - enhanced with measurable criteria]
- ✓ [Checkpoint 2 - enhanced with measurable criteria]
- ✓ [Checkpoint 3 - added if missing]

---

## EXECUTION PROTOCOL: [REASONING PATTERN NAME]

[Embedded reasoning pattern instructions here - from section 2.5]

### STEP 1: [Step Name]
**[STRICT]** [Step instructions - enhanced with specificity]

[Detailed step content - enhanced with measurable criteria]

#### Validation Checkpoint 1
**[STRICT]** Verify:
- ✓ [Validation criteria - enhanced with measurable thresholds]
- ✓ [Additional criteria - added if missing]
...
[Format specifications from 2.8 - enhanced with specificity]
...
### Success Criteria
- [Criterion 1]: [Measurable standard - enhanced with thresholds]
- [Criterion 2]: [Measurable standard - enhanced with thresholds]

### Quality Gates
**[STRICT]** The output MUST meet:
- ✓ [Gate 1]: [Threshold - enhanced with specific criteria]
- ✓ [Gate 2]: [Threshold - enhanced with specific criteria]

### Edge Case Handling
- **Case 1**: [Description] → [Handling procedure - enhanced with specificity]
- **Case 2**: [Description] → [Handling procedure - enhanced with specificity]

### Error Handling
- **Error Type 1**: [Description] → [Recovery procedure - enhanced with specificity]
- **Error Type 2**: [Description] → [Recovery procedure - enhanced with specificity]

---

## FINAL VALIDATION CHECKPOINT
**[STRICT]** Before completing, verify:
- ✓ [Final check 1 - enhanced with measurable criteria]
- ✓ [Final check 2 - enhanced with measurable criteria]
- ✓ [Final check 3 - enhanced with measurable criteria]
- ✓ [Final check 4 - added if missing]
```
...
3. **Logical Completeness**
   ...
   - ✓ Is context and prerequisites section complete (section 2.4)? (Check all required elements present)
   - ✓ Is reasoning pattern properly integrated (section 2.5)? (Verify pattern embedded naturally)
   - ✓ Are specificity enhancements applied (section 2.6)? (Check all vague terms replaced)
   - ✓ Are validation and quality gates added (section 2.7)? (Verify all checkpoints and gates present)
   - ✓ Is output format clearly specified (section 2.8)? (Check all format requirements explicit)
...
4. **Reasoning Pattern Integration**
   ...
   - ✓ Is the reasoning pattern integrated naturally into the execution flow? (Check natural embedding)
...
5. **Specificity Enhancement**
   ...
   - ✓ Are format requirements explicitly specified? (Check all format elements detailed)

6. **Quality Gates & Validation**
   - ✓ Are validation checkpoints clearly defined at logical breakpoints? (Verify checkpoint placement)
   - ✓ Are success criteria measurable and specific? (Check all criteria quantified)
   - ✓ Are edge cases identified and handled? (Verify edge case coverage)
   - ✓ Is error handling specified for common failure modes? (Check error handling completeness)

7. **Actionability**
   - ✓ Can an LLM execute this enhanced prompt effectively without ambiguity? (Test for clarity)
   - ✓ Are all required inputs, tools, and resources clearly specified? (Verify input specification completeness)
   - ✓ Is the execution protocol clear and step-by-step? (Check protocol clarity)
