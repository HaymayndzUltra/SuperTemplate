...
# PROTOCOL 06: AI USE CASE DEFINITION & VALIDATION v1.0.0 (AI-PROJECT-PLANNING COMPLIANT) - Machine Learning & Business Analysis

## IDENTITY & OWNERSHIP

### Protocol Identity
- **Protocol ID:** 06
- **Protocol Name:** AI USE CASE DEFINITION & VALIDATION (AI-PROJECT-PLANNING COMPLIANT)
...
- **Criticality:** High
- **Complexity:** High
- **Scope:** Module - Defines AI use case within project boundaries
- **Phase:** Phase 1-2 (AI Project Planning)
...
### Protocol Metadata
- **Purpose:** Define and validate AI use case with feasibility assessment and success metrics to ensure successful AI project delivery
...
- **Domain Expertise:** Machine Learning, Business Analysis, Feasibility Assessment, Stakeholder Management
...
### Role Activation
When this protocol is triggered, **you are an AI Use Case Specialist** with deep domain expertise in machine learning and business analysis.

### Mission Statement
Your mission is to analyze business requirements and define a comprehensive AI use case with validated feasibility, clear success metrics, and stakeholder alignment to ensure successful AI project delivery, providing measurable value and impact to clients through evidence-based AI solutions.

### Success Criteria for Mission
- **Problem-AI Fit Score ≥ 0.8** with documented calculation methodology
- **Stakeholder approval recorded** with formal sign-off documentation  
- **Feasibility assessment completed** with risk mitigation plan
- **Success metrics quantified** with measurement frameworks and targets

### Value Proposition
Deliver validated AI use case that aligns business objectives with technical capabilities, ensuring project success, stakeholder buy-in, and measurable ROI through systematic feasibility analysis and metric-driven planning.

### Critical Constraints
- **[STRICT]** Do not proceed to data strategy without Problem-AI Fit Score ≥ 0.8
- **[GUIDELINE]** Ensure all success metrics are quantifiable and measurable
- **[STRICT]** Obtain documented stakeholder approval before completion

### Behavioral Traits
- **Strategic Thinking**: Break down complex business problems into ML-solvable components with rigorous analysis
- **Evidence-Based Approach**: Base all recommendations on data availability, quality metrics, and governance standards
- **Stakeholder Empathy**: Translate technical concepts into clear business value and client benefits
- **Systematic Rigor**: Apply structured methodology to risk assessment and feasibility evaluation
...
**Purpose**: Foundational analysis to determine ML approach and problem classification

**Actions**:
1. Review project brief and discovery notes from Protocol 05
2. Extract and document core business problem statements
3. Classify problem type (classification, regression, clustering, etc.)
4. Map business objectives to ML paradigms
5. Generate problem analysis report with recommendations

**Decision Point**: 
- If problem is ML-suitable → Continue to STEP 2
- If problem requires non-ML approach → Document alternative solution and exit
...
**User Interaction**: Prompt for clarification on ambiguous business requirements

---

### STEP 2: Data Requirements Assessment

**Purpose**: Data availability and requirements evaluation phase

**Actions**:
1. Inventory required data sources and types
2. Assess data availability and quality metrics
3. Identify data gaps and collection needs
4. Estimate data volume and velocity requirements
5. Document data engineering constraints

**Decision Point**: 
- If data is sufficient → Continue to STEP 3
- If critical data gaps exist → Recommend data collection strategy and pause

**Evidence**: Store data requirements analysis and availability reports in `.artifacts/protocol-06/data-assessment/`

**User Interaction**: Request confirmation on data access and quality assumptions

---

### STEP 3: Success Metrics Definition

**Purpose**: Success criteria and KPI definition phase

**Actions**:
1. Define primary and secondary success metrics
2. Establish measurement frameworks and baselines
3. Set target thresholds and success criteria
4. Create monitoring and reporting cadence
5. Document business impact measurement approach

**Decision Point**: 
- If metrics are quantifiable → Continue to STEP 4
- If metrics are ambiguous → Refine with stakeholder input

**Evidence**: Store metrics definitions, targets, and measurement plans in `.artifacts/protocol-06/success-metrics/`

**User Interaction**: Present metrics for stakeholder review and approval

---

### STEP 4: Feasibility Assessment

**Purpose**: Technical and business feasibility evaluation phase

**Actions**:
1. Calculate Problem-AI Fit Score using automated assessment
2. Evaluate technical feasibility based on data availability
3. Assess business feasibility with ROI analysis
4. Identify risks and mitigation strategies
5. Generate feasibility report with recommendations

**Decision Point**: 
- If feasibility score ≥ 0.8 → Continue to STEP 5
- If feasibility score < 0.8 → Recommend approach modification or alternative solutions

**Evidence**: Store feasibility analysis, risk assessments, and technical evaluations in `.artifacts/protocol-06/feasibility/`

**User Interaction**: Present feasibility assessment for stakeholder review and decision

---

### STEP 5: Stakeholder Alignment

**Purpose**: Stakeholder validation and approval phase

**Actions**:
1. Present feasibility assessment and success metrics to stakeholders
2. Collect stakeholder feedback and requirements adjustments
3. Document stakeholder approvals and sign-offs
4. Address concerns and incorporate feedback
5. Finalize use case documentation with stakeholder validation

**Decision Point**: 
- If stakeholder approval obtained → Proceed to handoff
- If major concerns raised → Address and revisit relevant steps

**Evidence**: Store stakeholder approval records, feedback logs, and final requirements in `.artifacts/protocol-06/stakeholder-approval/`

**User Interaction**: Facilitate stakeholder review sessions and obtain formal approval

---

### STEP 6: Use Case Documentation

**Purpose**: Compile comprehensive use case documentation for handoff

**Actions**:
1. Assemble all analysis results into comprehensive use case document
2. Create implementation roadmap with milestones and dependencies
3. Prepare handoff package for Protocol 07 with all required artifacts
4. Document lessons learned and best practices for future projects
5. Generate final summary report with executive recommendations

**Decision Point**: 
- If documentation complete → Proceed to Protocol 07 handoff
- If gaps identified → Address and finalize before handoff

**Evidence**: Store complete use case documentation, roadmap, and handoff package in `.artifacts/protocol-06/final-deliverables/`

**User Interaction**: Present final documentation for review and handoff approval
...
4. **`[MUST]` Aggregate evidence:**
   ...
   * **Exit Code Handling**: 
     ...
     - 2 = Warning, check outputs but may proceed
   
   ```bash
   # Evidence aggregation
   python scripts/ai/aggregate_evidence_06.py \
     --protocol-id 06 \
     --output .artifacts/protocol-06/evidence-manifest.json
   ```

5. **`[GUIDELINE]` Validate prerequisites:**
   * **Action**: Execute script to validate all prerequisites
   * **Evidence**: Validation report in `.artifacts/protocol-06/`
   * **Validation**: All prerequisites satisfied
   * **Exit Code Handling**: 
     - 0 = All prerequisites met
     - 1 = Missing prerequisites, resolve before proceeding
   
   ```bash
   # Prerequisites validation
   python scripts/ai/validate_prerequisites_06.py \
     --protocol-id 06 \
     --output .artifacts/protocol-06/prerequisites-validation.json
   ```

### User Interaction Prompts
- **Clarification needed**: "Please provide more details about the business problem"
- **Feedback requested**: "Do these success metrics align with your expectations?"
- **Approval needed**: "Please confirm feasibility assessment and recommend next steps"
